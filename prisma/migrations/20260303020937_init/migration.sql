-- CreateEnum
CREATE TYPE "RoleCode" AS ENUM ('ADMIN', 'STAFF', 'VET', 'OWN');
...
-- CreateEnum
CREATE TYPE "block_type" AS ENUM ('TIME_OFF', 'MEETING', 'OTHER');
...
CREATE TABLE "otp_code" (
    ...
    CONSTRAINT "otp_code_pkey" PRIMARY KEY ("_id")
);
...
CREATE TABLE "staff_profile" (
    ...
    "employment_status" "employment_status" NOT NULL DEFAULT 'WORKING',
    ...
    CONSTRAINT "staff_profile_pkey" PRIMARY KEY ("_id")
);
...
CREATE TABLE "vet_profile" (
    ...
    CONSTRAINT "vet_profile_pkey" PRIMARY KEY ("_id")
);
...
CREATE TABLE "owner_profile" (
    ...
    CONSTRAINT "owner_profile_pkey" PRIMARY KEY ("_id")
);
...
CREATE TABLE "microchip_record" (
    ...
    "pet_id" UUID NOT NULL,
    "microchip_item_id" UUID NOT NULL,
    "implant_site" VARCHAR(100) NOT NULL,
...
-- CreateIndex
CREATE INDEX "otp_code_user_id_idx" ON "otp_code"("user_id");

-- CreateIndex
CREATE INDEX "otp_code_expires_at_idx" ON "otp_code"("expires_at");
...
-- CreateIndex
CREATE UNIQUE INDEX "staff_profile_user_id_key" ON "staff_profile"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "staff_profile_staff_code_key" ON "staff_profile"("staff_code");

-- CreateIndex
CREATE UNIQUE INDEX "staff_profile_citizen_id_key" ON "staff_profile"("citizen_id");

-- CreateIndex
CREATE INDEX "staff_profile_employment_status_idx" ON "staff_profile"("employment_status");

-- CreateIndex
CREATE INDEX "staff_profile_employment_type_idx" ON "staff_profile"("employment_type");

-- CreateIndex
CREATE INDEX "staff_profile_join_date_idx" ON "staff_profile"("join_date");

-- CreateIndex
CREATE UNIQUE INDEX "vet_profile_user_id_key" ON "vet_profile"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "vet_profile_license_no_key" ON "vet_profile"("license_no");

-- CreateIndex
CREATE UNIQUE INDEX "vet_profile_citizen_id_key" ON "vet_profile"("citizen_id");

-- CreateIndex
CREATE INDEX "vet_profile_join_date_idx" ON "vet_profile"("join_date");

-- CreateIndex
CREATE INDEX "vet_profile_employment_status_idx" ON "vet_profile"("employment_status");
...
-- CreateIndex
CREATE INDEX "appointment_slot_vet_id_slot_date_idx" ON "appointment_slot"("vet_id", "slot_date");
...
-- AddForeignKey
ALTER TABLE "user" ADD CONSTRAINT "user_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "role"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "otp_code" ADD CONSTRAINT "otp_code_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "staff_profile" ADD CONSTRAINT "staff_profile_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vet_profile" ADD CONSTRAINT "vet_profile_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "owner_profile" ADD CONSTRAINT "owner_profile_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pet" ADD CONSTRAINT "pet_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "appointment" ADD CONSTRAINT "appointment_staff_id_fkey" FOREIGN KEY ("staff_id") REFERENCES "staff_profile"("_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "appointment" ADD CONSTRAINT "appointment_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "appointment" ADD CONSTRAINT "appointment_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "microchip_record" ADD CONSTRAINT "microchip_record_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "microchip_record" ADD CONSTRAINT "microchip_record_microchip_item_id_fkey" FOREIGN KEY ("microchip_item_id") REFERENCES "microchip"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "health_cer_record" ADD CONSTRAINT "health_cer_record_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "invoice" ADD CONSTRAINT "invoice_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payment" ADD CONSTRAINT "payment_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "owner_voucher" ADD CONSTRAINT "owner_voucher_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "loyalty_point" ADD CONSTRAINT "loyalty_point_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "owner_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "working_shift" ADD CONSTRAINT "working_shift_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "appointment_slot" ADD CONSTRAINT "appointment_slot_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "block_time" ADD CONSTRAINT "block_time_vet_id_fkey" FOREIGN KEY ("vet_id") REFERENCES "vet_profile"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
